...
#define N_FLAG_BYTES ((1 << (sizeof(OldKey) * 8)) / 8)  // This times 8 is the number of items JB's hash map can hold. Increase as necessary. 
...
#define FALSE (0)
#define KEY_MIN (1)
#define KEY_MAX ((1 << (sizeof(OldKey) * 8)) - 1)
