...
{
    fluid_midi_event_t *next; /* Link to next event */  // MB: eliminate this crap
...
{
    char *name;   // MB: don't need this
    int num;      // MB: this can just an index
    fluid_midi_event_t *first;   // MB: get rid of this BS and use an array
    fluid_midi_event_t *cur;     // MB: get rid of this BS and use an array
    fluid_midi_event_t *last;    // MB: get rid of this BS and use an array
    unsigned int ticks;          // MB: This is important
};
