...
typedef Error (*XIniSubcompU)(struct _System *sP, void *dataP, void *dataSrcP);
...
typedef struct _System {
  ...
  XIniSubcompU    iniComp;              // Some systems need to inflate components before using them. 
