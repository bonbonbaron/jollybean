...
uobikiemukot/drm_test.c
   ...
   Code Revisions 2 Stars 23 Forks 2
   Embed
   What would you like to do?
   (<script src="https://gist.github.com/uobikiemukot/c2be4d7515e977fd9e85.js"></script>)
   Embed Embed this gist in your website.
   (https://gist.github.com/uobikiemukot/c2be4d7515e977fd9e85)
   Share Copy sharable link for this gist.
   (https://gist.github.com/c2be4d7515e977fd9e85.git)
   ...
   *(dev->buf + i * dev->width + j) = (uint32_t) 0xFFFFFF & (0x00 << 16 | color << 8 | color);
   ...
   stefanalt commented Dec 12, 2020 •
   edited

   Nice. Almost certainly you need to fix the /* draw something */ body with something this:

   *(dev->buf + i * (dev->pitch/(BPP/8)) + j) = (uint32_t) 0xFFFFFF & (0x00 << 16 | color << 8 |
   color);

   Sometimes pitch != width !
